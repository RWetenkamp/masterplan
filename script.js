function loadKnown(event) {
    switch (event) {
        ...
        case "degrees":
            ...
            document.getElementById('knownDegrees').innerHTML = '';
            var xmlHttp = new XMLHttpRequest();
            xmlHttp.open( "GET", "../api/getDegrees.php", false ); // false for synchronous request
            xmlHttp.send( null );
            var response = xmlHttp.responseText;
            var resultArray = JSON.parse(response);
            document.getElementById("knownDegrees").innerHTML = "";
        ...
        case "topics":
            ...
            document.getElementById('knownDegrees').innerHTML = '';
            var xmlHttp = new XMLHttpRequest();
            xmlHttp.open("GET", "../api/getCategories.php", false);
            xmlHttp.send( null );
            var response = xmlHttp.responseText;
            var resultArray = JSON.parse(response);
            document.getElementById("knownTopics").innerHTML = "";
...
function getRequirements(id) {
    if (document.getElementById("requ-"+id).classList.contains("hidden")) {
        var xmlHttp = new XMLHttpRequest();
        xmlHttp.open("GET", "../api/getRequirements.php?id="+id, false);
        xmlHttp.send( null );
        var response = xmlHttp.responseText;
        var resultArray = JSON.parse(response);
...
function search() {
    ...
    var xmlHttp = new XMLHttpRequest();
    xmlHttp.open("GET", "../api/getData.php?states="+states+"&degrees="+degrees+"&topics="+topics+"&query="+query, false);
    xmlHttp.send( null );
    var response = xmlHttp.responseText;
    var resultArray = JSON.parse(response);
