<?php
    ...
    if ($link->connect_error) {
        ...
        if ($hflag == "Geschichte") {
            $sql = "SELECT DISTINCT degree FROM programs_hist ORDER BY category ASC";
        }
        else {
            $sql = "SELECT DISTINCT degree FROM programs ORDER BY category ASC";
        }
